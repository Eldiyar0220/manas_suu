...
class AuthLoginResponseModel {
  const AuthLoginResponseModel({required this.data});

  final AuthLoginDataModel data;

  factory AuthLoginResponseModel.fromJson(Map<String, dynamic> json) => _$AuthLoginResponseModelFromJson(json);
...
class AuthLoginDataModel {
  ...
  factory AuthLoginDataModel.fromJson(Map<String, dynamic> json) => _$AuthLoginDataModelFromJson(json);
